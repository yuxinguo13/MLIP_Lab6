...
## Environment Set Up
Since we recommend you to use team server, your teammate may already finish this step on your team server. $${\color{red}Red}$$ **Please do not install Java and Jenkins again if your teammate have already done it.**
